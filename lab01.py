def main():
    ...
    print(f'quantity = {quantity}') # a sample for you to use for the other prices
    print(f'subtotal_cost = ${subtotal_cost:0.2f}') # a sample for you to use for the other prices
    print(f'tax = ${tax:0.2f}') # a sample for you to use for the other prices
    print(f'total_cost = ${total_cost:0.2f}') # a sample for you to use for the other prices
